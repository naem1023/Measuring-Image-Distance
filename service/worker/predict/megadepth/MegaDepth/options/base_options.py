...
from megadepth.MegaDepth.util import util
...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default=os.path.join('megadepth', 'MegaDepth', 'checkpoints'), help='models are saved here')
